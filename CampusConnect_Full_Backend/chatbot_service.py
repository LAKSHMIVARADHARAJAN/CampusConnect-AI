...
# ---------------- DEPARTMENT ALIASES ----------------
DEPT_ALIASES = {
    "computer science engineering": ["cse", "cs", "comp sci", "computer", "cs dept", "computer science department"],
    "mechanical engineering": ["mech", "mechanical eng", "mechanical dept"],
    ...
    "data science":["ds","DS","data science","datascience","Datascience","Data science"]
}
